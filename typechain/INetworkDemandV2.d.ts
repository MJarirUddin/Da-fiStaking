...
interface INetworkDemandV2Interface extends ethers.utils.Interface {
  functions: {
...
export class INetworkDemandV2 extends BaseContract {
  ...
  interface: INetworkDemandV2Interface;
